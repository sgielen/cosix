...
void thread::handle_syscall() {
	...
	case 33: error = syscall_mem_lock(c); break;
	case 34: error = syscall_mem_map(c); break;
	case 35: error = syscall_mem_protect(c); break;
	case 36: error = syscall_mem_sync(c); break;
	case 37: error = syscall_mem_unlock(c); break;
	case 38: error = syscall_mem_unmap(c); break;
	case 39: error = syscall_poll(c); break;
	case 40: error = syscall_poll_fd(c); break;
	case 41: error = syscall_proc_exec(c); break;
	case 42: error = syscall_proc_exit(c); break;
	case 43: error = syscall_proc_fork(c); break;
	case 44: error = syscall_proc_raise(c); break;
	case 45: error = syscall_random_get(c); break;
	case 46: error = syscall_sock_accept(c); break;
	case 47: error = syscall_sock_bind(c); break;
	case 48: error = syscall_sock_connect(c); break;
	case 49: error = syscall_sock_listen(c); break;
	case 50: error = syscall_sock_recv(c); break;
	case 51: error = syscall_sock_send(c); break;
	case 52: error = syscall_sock_shutdown(c); break;
	case 53: error = syscall_sock_stat_get(c); break;
	case 54: error = syscall_thread_create(c); break;
	case 55: error = syscall_thread_exit(c); break;
	case 56: error = syscall_thread_yield(c); break;
	default:
