...
cloudabi_errno_t syscall_sock_accept(syscall_context &c);
cloudabi_errno_t syscall_sock_bind(syscall_context &c);
cloudabi_errno_t syscall_sock_connect(syscall_context &c);
cloudabi_errno_t syscall_sock_listen(syscall_context &c);
...
cloudabi_errno_t syscall_sock_stat_get(syscall_context &c);
